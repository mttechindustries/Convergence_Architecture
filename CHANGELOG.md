...
- Public repository front page and architecture map
- Explicit public/private publication boundary
- Public Convergence Architecture technical synthesis
- Aerial and ambient sensing extension
- Representation Gap and Representation Paradox research brief
- Protocol-governance design requirements
- Public evidence standard and advancement rules
- August 4, 2026 evidence-status snapshot
- Primary-source starter index with claim boundaries
- Contribution and evidence-submission requirements
- Citation metadata
- Rights notice
...
```text
COMPONENT BASIS: STRONG, MULTI-DOMAIN, AND AERIALLY EXTENDED
INTEGRATED CASE CLOSURE: OPEN
EVENT-SPECIFIC ATTRIBUTION: REQUIRES RECORDS
```
...
Commercial pricing, outreach copy, private testimony, protected mathematics, private Drive links, internal ledgers, device or channel signatures, calibration constants, and deployment-specific validation sequences were deliberately excluded.
